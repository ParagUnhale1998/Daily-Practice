...
ngDoCheck(): void {
  ...
  updateProgressBarUsingMath() {
    ...
    const filledFields = Object.keys(formValue).filter((key) => !!formValue[key]).length;
      switch (filledFields) {
        case 3:
          this.updateProgressBar('info',5,'5%')
          break;
          case 4:
            this.updateProgressBar('info',10,'10%')
            break;
            case 5:
            this.updateProgressBar('info',20,'20%')
            break;
            case 6:
            this.updateProgressBar('info',25,'25%')
            break;
            case 7:
            this.updateProgressBar('info',30,'30%')
            break;
            case 8:
